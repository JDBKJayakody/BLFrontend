    ...
    <>
      ...
      <Row style={{ marginTop: '100px' }}>
        ...
        <Col xs={22} sm={6} md={6} lg={6} xl={6} xxl={6} style={{ borderRadius: '30px', border: '4px solid #daa520' }}>
          <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New' }}>GOLD PACKAGE</h1></b>
          <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New', color: '#daa520' }}>Rs.20000/=</h1></b>
        ...
        <Col xs={22} sm={6} md={6} lg={6} xl={6} xxl={6} style={{ borderRadius: '30px', border: '4px solid #daa520' }}>
          <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New' }}>PREMIERE PACKAGE</h1></b>
          <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New', color: '#daa520' }}>Rs.25000/=</h1></b>
          <ul style={{ fontSize: '20px', fontFamily: 'Courier New', color: '#00125D' }}>
            <li>JBL Sound System</li>
            <li>LED Colour Wash 4</li>
            <li>LED Disco 1</li>
        ...
        <Col xs={1} sm={1} md={1} lg={1} xl={1} xxl={1}></Col>
        <Col xs={22} sm={6} md={6} lg={6} xl={6} xxl={6} style={{ borderRadius: '30px', border: '4px solid #daa520' }}>
          <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New' }}>VIP PACKAGE</h1></b>
          <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New', color: '#daa520' }}>Rs.45000/=</h1></b>
          <ul style={{ fontSize: '20px', fontFamily: 'Courier New', color: '#00125D' }}>
      ...
      <Row style={{ marginTop: '50px', marginBottom: '50px' }}>
        ...
        <Col xs={24} sm={16} md={16} lg={16} xl={16} xxl={16}>
          <div>
            <b><h1 style={{ fontSize: '30px', fontFamily: 'Courier New' }}>10% discount is available for each PACKAGE.</h1></b>
          </div>
        </Col>
      </Row>
